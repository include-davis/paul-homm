  ...
  return (
    <div className={styles.slideContainer}>
      ...
      <div className={styles.slideContainer}>
        <div
          className={
            currTab === 1 ? `${styles.activeSlide}` : `${styles.inactiveSlide}`
          }
        >
          <div className={styles.imageContainer}>
            <Image
              className={styles.image}
              src="/images/services/specialtyClinics.png"
              width={478}
              height={345}
              alt="Clinic staff"
            />
        ...
        <div
          className={
            currTab === 2 ? `${styles.activeSlide}` : `${styles.inactiveSlide}`
          }
        >
          <div className={styles.imageContainer}>
            <Image
              className={styles.image}
              src="/images/services/hepatitis.png"
              width={478}
              height={345}
        ...
        <div
          className={
            currTab === 3 ? `${styles.activeSlide}` : `${styles.inactiveSlide}`
          }
        >
          <div className={styles.imageContainer}>
            <Image
              className={styles.image}
              src="/images/services/healthEdu.png"
              width={478}
              height={345}
              alt="Clinic students"
            />
        ...
        <div
          className={
            currTab === 4 ? `${styles.activeSlide}` : `${styles.inactiveSlide}`
          }
        >
          <div className={styles.imageContainer}>
            <Image
              className={styles.image}
              src="/images/services/vaccines.png"
              width={478}
              height={345}
              alt="Woman receiving vaccine"
            />
          </div>
